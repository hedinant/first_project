...
public class DemoKurs1 {
    ...
    public static void main(String[] args) {
        ...
        TradeItem futures1=new TradeItem();
//        futures1.price = 50;
...
//        futures1.intrinsicPrice = (float)(100*Math.random());
       ...
       /* for (int t=1;t<=100;t++) {
        ...
        int n=10;
        TradeItem futuresBuy[]=new TradeItem[n];
        TradeItem futuresSale[]=new TradeItem[n];
        TradeItem optionBuy[]=new TradeItem[n];
        TradeItem optionSale[]=new TradeItem[n];
